...
<button id="crearfactura" class="btn btn-success" type="button">Crear Facturas Venta</button>
...
<br>
		...
		<div class="panel panel-danger" style="width:700px;" align="left">
		<div class="panel-heading">
			...
			<div class="panel-body">
				<form class="formulario" role="form">
                    ...
                    <input type="hidden" id="proveedor" name="proveedor" value="1"/>
